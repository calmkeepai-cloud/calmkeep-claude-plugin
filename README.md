...
The Calmkeep Claude plugin routes Claude Code prompts through the Calmkeep runtime before they reach the Anthropic API.
...
If you'd like, I can also show you **one very small README tweak that will make the plugin far easier for developers to discover in the Claude plugin marketplace**, which can help early adoption once you announce Calmkeep.
